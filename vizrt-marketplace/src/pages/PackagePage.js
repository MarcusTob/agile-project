...
const PackagePage = () => {
  ...
  switch(activeTab) {
    case "About":
      ...
      break;
    case "Specifications":
      content = <p>Our package is made from high-quality materials that provide superior support and comfort.</p>;
      break;
    case "Reviews":
      content = <p>Our package has received excellent reviews from users around the world.</p>;
      break;
    default:
      content = <p>{graphicPackage.description}</p>;
  }
  ...
  return (
    <div className="bg-brandBgLight min-h-screen flex flex-col items-center px-4 sm:px-0">
      <div className="mt-8">
        <PackageDetailsAndImage imageUrl={imageUrl} graphicPackage={graphicPackage} />
      </div>
