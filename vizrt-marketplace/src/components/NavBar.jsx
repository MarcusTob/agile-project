...
export const Navbar = ({
  ...
  communityIcon = "https://c.animaapp.com/2XehKRee/img/community-icon.png",
  ...
  return (
    <div className="w-[1512px] h-[154px] bg-white relative">
      ...
      >
        ...
        <div
          className={`left-0 top-0 absolute ${property1 === "default" ? "w-[230px]" : "w-[66px]"} ${
            property1 === "default" ? "h-[129px]" : "h-[59px]"
          }`}
        >
          {property1 === "default" && (
            <p className="absolute w-[204px] h-[45px] top-[84px] left-[26px] text-[25px] text-[#000000] text-center font-medium">
              <span>Start </span>
              <span>Selling</span>
            </p>
          )}
          ...
          <img
            className={`left-0 absolute ${property1 === "variant-2" ? "w-[53px]" : "w-[88px]"} ${
              property1 === "variant-2" ? "top-[12px]" : "top-0"
            } ${property1 === "variant-2" ? "h-[47px]" : "h-[88px]"}`}
            alt="Community icon"
            src={property1 === "variant-2" ? "shopping-cart.svg" : communityIcon}
          />
          {property1 === "variant-2" && (
            <>
